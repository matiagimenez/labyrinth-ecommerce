...
export const Catalog: FunctionComponent = () => {
	...
	return (
		<section className='pt-24 w-full' id='Products'>
			...
			<section className='grid max-w-[400px] min-h-[300px] ml-auto mr-auto w-[90%] sm:max-w-full sm:w-full sm:px-4 sm:ml-0 sm:mr-0 grid-cols-1 justify-items-center items-center gap-y-4 gap-x-2 mt-2 sm:grid-cols-2 lg:grid-cols-3 lg:pl-1 xl:grid-cols-4'>
				{status === 'loading' && (
