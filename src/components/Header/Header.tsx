...
export const Header = () => {
	return (
		<header className='bg-cyan z-10 min-h-[90px] h-[10%] p-5 pl-3 fixed top-0 w-full sm:pl-6 md:min-h-[100px] shadow-md '>
			...
			<nav className='inline-block w-[40%] absolute top-9 right-5 sm:right-10 md:right-32'>
