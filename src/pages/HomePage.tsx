...
export const HomePage: FunctionComponent = () => {
	return (
		<>
			<section className='overflow-hidden min-h-[90vh] justify-center pb-16 relative flex flex-col items-center md:min-h-fit md:pt-8 md:flex-row md:items-center xl:mt-2'>
