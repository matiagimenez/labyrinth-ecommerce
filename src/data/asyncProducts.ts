export const products = [
	...
	},
	{
      ...
      GeForce MX450`,
		...
		description:
			'Da rienda suelta a tu creatividad. La serie ASUS Zenbook te da las herramientas para ser más creativo. Zenbook te permite maximizar tu potencial creativo con una combinación única de rendimiento, velocidad, elegancia y precisión. Un versátil e innovador convertible 2 en 1 con una pantalla de 360 grados que permite utilizarlo como un portátil fino y ligero, una práctica tableta o en cualquier posición intermedia.',
		features: {
			cpu: {
				title: 'Procesador',
